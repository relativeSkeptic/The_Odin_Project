...
insuranceTodo.set("priority", "Yes");
...
warrantyTodo.set(
  "description",
  "Monitor roof after install for any issues and file against warranty",
);
warrantyTodo.set("dueDate", "2/30/2099");
warrantyTodo.set("priority", "No");
...
reviewTodo.set(
  "description",
  "Write a review describing the quality of work done by the roofers",
);
reviewTodo.set("dueDate", "3/5/2099");
reviewTodo.set("priority", "No");
...
extendedWarrantyTodo.set(
  "description",
  "Review potential warranty claims again after one year",
);
extendedWarrantyTodo.set("dueDate", "2/30/2100");
extendedWarrantyTodo.set("priority", "No");

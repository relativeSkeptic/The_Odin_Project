...
import { closeProjectModal, closeTodoModal, displayProjectModal, displayTodoModal } from "./modals";
...
function addTodoEventListener(object) {
    document.getElementById(object.id + "_create_todo").addEventListener("click", ()=> {
        displayTodoModal(NEW);
    });
}   

export { projectEventListeners, todoEventListeners, addTodoDisplayListener, addTodoEventListener };